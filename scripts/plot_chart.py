...
def plot_fig(df: pandas.core.frame.DataFrame, x: str,y : str, legend:Optional[str]=None, normalize:bool = False):  
    ...
    # plot scatterplot
    if legend:
        seaborn.scatterplot(x=x, y=y,hue=legend, data=df,legend=True)
    elif not legend:
        seaborn.scatterplot(x=x, y=y, data=df, legend=True)   
